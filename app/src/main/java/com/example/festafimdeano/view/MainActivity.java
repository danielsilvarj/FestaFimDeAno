...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private int getDaysLeft(){
        Calendar caneldarToday = Calendar.getInstance();

        int today = caneldarToday.get(Calendar.DAY_OF_YEAR);

        Calendar caneldarLastday = Calendar.getInstance();
        int dayMax = caneldarLastday.getActualMaximum(Calendar.DAY_OF_YEAR);
